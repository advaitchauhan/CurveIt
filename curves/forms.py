...
class Course_SpecificForm(forms.Form):
    ...
    pastSemClass1 = forms.ModelChoiceField(queryset = curClasses, widget=autocomplete_light.ChoiceWidget('Course_SpecificAutocomplete'), label = "courseInput", help_text="Class*", required=True)
    grade1 = forms.ChoiceField(choices=Course_Specific.CHOICES, label = "gradeInput", help_text="Grade*")
    pastSemClass2 = forms.ModelChoiceField(queryset = curClasses,  widget=autocomplete_light.ChoiceWidget('Course_SpecificAutocomplete'), label = "courseInput", help_text="Class*", required=True)
    grade2 = forms.ChoiceField(choices=Course_Specific.CHOICES, label = "gradeInput", help_text="Grade*")
    pastSemClass3 = forms.ModelChoiceField(queryset = curClasses, widget=autocomplete_light.ChoiceWidget('Course_SpecificAutocomplete'), label = "courseInput", help_text="Class*", required=True)
